...
select lives_ok(
  $$select api.create_request('Fixture calibration','Motion bench',now() + interval '1 day',now() + interval '3 days','[{"catalog_item_id":"00000000-0000-0000-0000-000000000101","quantity":1}]'::jsonb,'request-test-0001')$$,
