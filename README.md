...
No production deployment is configured by this repository. Vercel, Supabase, institution-owned SMTP for Supabase Auth confirmation/security mail, scheduled `POST /api/jobs/retention`, automated backups, alerts, and production domains require institution-owned projects and secrets. Password recovery uses the admin-reviewed manual reset queue. Application events are in-app only; no application-email provider is part of the approved design. Follow [docs/PRODUCTION_RELEASE.md](docs/PRODUCTION_RELEASE.md), [docs/OPERATIONS.md](docs/OPERATIONS.md), [docs/SECURITY.md](docs/SECURITY.md), and [docs/VERIFICATION_REPORT.md](docs/VERIFICATION_REPORT.md) before a pilot.
